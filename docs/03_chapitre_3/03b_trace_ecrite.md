...
## 1️⃣ Décrire quantitativement une solution cosmétique
...
## 4️⃣ Méthode BTS à retenir (essentielle)

Pour résoudre un exercice de concentration en BTS MECP :
...
5. **Calculer**  
6. **Interpréter** le résultat par une phrase complète  
