...
# S17 – Représentations des molécules organiques 📝
...
### Document 1 – Les trois modes de représentation
...
$$\boxed{\text{CH}_3\text{–CH}_2\text{–CH}_2\text{–CH}_3}$$
...
- Les hydrogènes liés à chaque carbone sont **écrits** (CH₃, CH₂)
- Les liaisons C–H ne sont **pas dessinées** (pour simplifier)
...
- Chaque **extrémité** de trait = **1 atome de carbone**
- Les **hydrogènes** ne sont **pas écrits** (ils sont implicites : on sait qu'ils sont là pour compléter les 4 liaisons du carbone)
- Les **liaisons C–C** sont représentées par des **traits**

**Convention du carbone tétravalent :**
Le carbone fait **4 liaisons**. Si on ne voit que 2 ou 3 liaisons (avec d'autres carbones), le reste est complété par des hydrogènes (non dessinés).

**Exemple :**
- Un carbone en **bout de chaîne** (1 liaison visible) a **3 hydrogènes** : CH₃
- Un carbone au **milieu de chaîne** (2 liaisons visibles) a **2 hydrogènes** : CH₂
- Un carbone avec **3 liaisons visibles** a **1 hydrogène** : CH
...
### Document 2 – Les types de chaînes carbonées
...
### Document 3 – Méthode de conversion entre représentations

#### Semi-développée → Topologique

**Méthode :**

1. Repérer chaque **groupe** (CH₃, CH₂, CH, C)
2. Remplacer chaque groupe par un **sommet** ou une **extrémité**
3. Relier les sommets par des **traits** (liaisons C–C)
4. **Ne pas écrire** les hydrogènes
...
#### Topologique → Semi-développée

**Méthode :**

1. Compter les **sommets** et **extrémités** → nombre de carbones
2. Pour chaque carbone, compter les **liaisons visibles**
3. Compléter avec des **hydrogènes** pour arriver à **4 liaisons**
4. Écrire CH₃ (1 liaison), CH₂ (2 liaisons), CH (3 liaisons)
...
## 🧪 Travail 1 – Identifier les trois représentations (15 min)
...
3\. Vérification : la formule brute est-elle C₅H₁₂ ? _______

### 1.3 – Écrire la formule semi-développée à partir de la formule brute
...
## 🔍 Travail 2 – Identifier les types de chaînes carbonées (15 min)

> 🎯 **Compétence E2 : Analyser, Interpréter**

À partir du **Document 2**, complétez le tableau suivant :

### 2.1 – Identifier le type de chaîne
...
### 2.2 – Relier structure et propriété
...
## ✏️ Travail 3 – Convertir d'une représentation à l'autre (20 min)

> 🎯 **Compétence E2 : Analyser, Appliquer**

### 3.1 – Convertir semi-développée → topologique
...
### 3.2 – Convertir topologique → semi-développée
...
Formule semi-développée : _______
...
1\. Comptez le nombre de carbones : _______

2\. Comptez le nombre d'hydrogènes : _______

3\. Écrivez la formule brute : _______

---

## 🧴 Travail 4 – Identifier un ingrédient cosmétique (10 min)
...
### 4.1 – Identifier les molécules

| Formule topologique | Nombre de C | Type de chaîne | Particularités | Identification |
|:-------------------:|:-----------:|:--------------:|----------------|:--------------:|
| [Formule A] | _______ | _______ | Chaîne longue, linéaire | _______ |
| [Formule B] | _______ | _______ | 3 groupes OH | _______ |
| [Formule C] | _______ | _______ | Cycle + chaîne | _______ |

**Liste des molécules possibles :**
- Acide stéarique (C₁₈, acide gras)
- Glycérol (C₃H₈O₃, humectant, 3 OH)
- Rétinol (C₂₀H₃₀O, vitamine A, cycle + chaîne)
