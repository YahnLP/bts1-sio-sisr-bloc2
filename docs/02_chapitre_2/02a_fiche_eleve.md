...
# 02 Solutions : 📝 Fiche élève

**Décrire un mélange homogène : solution, solvant et soluté**
...
- Définir la notion de **solution**
- Identifier le **solvant** et le(s) **soluté(s)**
- Utiliser un vocabulaire scientifique précis pour décrire un produit cosmétique
